...
class CityRateCoreTests(TestCase):
    def setUp(self):
    ...
    def test_duplicate_email_rejected(self):
        ...
        response = self.client.post(reverse('signup'), {
            'username': 'other', 'password1': 'password123ABC!',
            'password2': 'password123ABC!', 'email': 'u1@test.com'
        })
    ...
    def test_draft_visibility(self):
        ...
        Post.objects.create(
            user=self.user1, city=self.city, review_text="Draft", is_draft=True, rating_score=4
        )
